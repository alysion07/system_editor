...
const headers = [
    ...
    'mflowj4','mflowj5',
    'mflowj6',"cntrlvar3",'mflowj7','mflowj8',
    'cntrlvar4','cntrlvar5',
    'cntrlvar6',
...
const groups = {
    PLOT1: ['rktpow1', 'cntrlvar1', 'cntrlvar2'],
    PLOT2: ['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8'],
    PLOT3: ['p9', 'p10'],
    PLOT4: ['tempf1', 'tempf2', 'tempf3', 'tempf4', 'tempf5', 'tempf6', 'tempf7'],
    PLOT5: ['mflowj1', 'mflowj2', 'mflowj3'],
    PLOT6: ['mflowj4', 'mflowj5'],
    PLOT7: ['mflowj6', 'cntrlvar3', 'mflowj7', 'mflowj8'],
    PLOT8: ['cntrlvar4', 'cntrlvar5'],
    PLOT9: ['cntrlvar6'],
    PLOT10: ['tempf8', 'tempf8', 'tempg1'],
    PLOT12: ['mflowj9', 'mflowj10'],
};
